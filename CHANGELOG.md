...
* fix(pose_estimation): Save config to outbox as dj_dlc_config ([`f69c46a`](https://github.com/yambottle/element-deeplabcut/commit/f69c46a7ff4d9ec62bdc57ce99315cfc241a8e59))
...
* test(CICD): 🧪 test flow ([`d63d324`](https://github.com/yambottle/element-deeplabcut/commit/d63d324ee30d99ec228cb5dd01fd8c8a98b36b71))
...
add plotting function to call dlc PlottingResults on PoseEstimation results ([`af4ce80`](https://github.com/yambottle/element-deeplabcut/commit/af4ce80acf21559b6f7c5eb53452432c4619135c))
...
* Merge branch &#39;main&#39; of https://github.com/ttngu207/element-deeplabcut ([`d1dcc46`](https://github.com/yambottle/element-deeplabcut/commit/d1dcc46aa3f3fbfbc093332ba594a8f38882e954))
...
Bugfix - store `snapshotindex` for the latest snapshot instead of the filename ([`1cf8347`](https://github.com/yambottle/element-deeplabcut/commit/1cf8347ea023bebd2c375f6ff725f7ced7d8ff8c))
...
* update version ([`4543d08`](https://github.com/yambottle/element-deeplabcut/commit/4543d087ccf51540d77a8b04facd4664dc8fae3d))
...
* move `import os` from `__init__` to `tutorial_pipeline` ([`95e10df`](https://github.com/yambottle/element-deeplabcut/commit/95e10df1e859d37843a8242efaa20395b0c359ee))
...
* Merge branch &#39;main&#39; of https://github.com/datajoint/element-deeplabcut into element-dlc-test ([`fe423f2`](https://github.com/yambottle/element-deeplabcut/commit/fe423f2bd3dfbfd2ab113354dc8eb71ad3cf6719))
...
* Merge branch &#39;element-dlc-test&#39; into element-dlc-test ([`a2b2fd2`](https://github.com/yambottle/element-deeplabcut/commit/a2b2fd28a3cdd1cb63fe082081d315f3e58dac3e))
...
* solve readme conflict ([`7ce6007`](https://github.com/yambottle/element-deeplabcut/commit/7ce600754d6301137e16bbddcd1622204671069a))
...
* revert model.py and train.py to add in next PR ([`1e6c27e`](https://github.com/yambottle/element-deeplabcut/commit/1e6c27ed0dce5e35ea713d26c64dd2008ba81482))
...
* test minor change in dependencies in dockerfile ([`f5eaae4`](https://github.com/yambottle/element-deeplabcut/commit/f5eaae46bd466d35c074945bd106ef80426e9df2))
...
* from IMAGING_ROOT_DATA_DIR to DLC_ROOT_DATA_DIR ([`9551723`](https://github.com/yambottle/element-deeplabcut/commit/955172331f11d3d77fe09e4fe624f4501b6d440f))
...
* Update intro tutorial notebook ([`3a2eba8`](https://github.com/yambottle/element-deeplabcut/commit/3a2eba8767cfee13923bb1963be72775a2006d7f))
...
* Update requirements ([`415145c`](https://github.com/yambottle/element-deeplabcut/commit/415145c1b00183623a8e1ac1766f0e05b9702f3f))
...
* Add class docstring for Device ([`b141b1e`](https://github.com/yambottle/element-deeplabcut/commit/b141b1e0d7144d72c3d43232abcb4f7e5f9faacb))
...
* WIP: migrate fixtures to conftest.py ([`c7ffd43`](https://github.com/yambottle/element-deeplabcut/commit/c7ffd4393626b2c47f473630d1c24be024620a2f))
...
* Merge from cbroz1:main ([`b414498`](https://github.com/yambottle/element-deeplabcut/commit/b414498dc9e97c45e141c451d1be06dfade7fa55))
...
* new notebook for modeling use ([`598b0e2`](https://github.com/yambottle/element-deeplabcut/commit/598b0e2974a92d0d6de9c6543be9f8fc0c883a1d))
...
* Create README.md ([`94546b1`](https://github.com/yambottle/element-deeplabcut/commit/94546b17b708874ef4536179a2c2bca29cd1cd24))
...
* update changelog releases ([`a21a471`](https://github.com/yambottle/element-deeplabcut/commit/a21a4715c343db6b8578b4213fe8a4ede5b84caa))
...
Co-authored-by: Chris Brozdowski &lt;CBrozdowski@yahoo.com&gt; ([`44607f2`](https://github.com/yambottle/element-deeplabcut/commit/44607f21cc16354e5ef408e8c765919fbf74211f))
...
* Update CHANGELOG.md ([`1391f7a`](https://github.com/yambottle/element-deeplabcut/commit/1391f7a1fd88dfcacc6b69cbdbdd56e768b595e6))
...
* Remove gitignore item for mkdocs notebook deployment ([`a97f998`](https://github.com/yambottle/element-deeplabcut/commit/a97f9980e2842424356f8153a85f8a047e062715))

* Merge pull request #55 from CBroz1/docs-tutorial

Tutorials folder with rendered notebooks ([`c628e32`](https://github.com/yambottle/element-deeplabcut/commit/c628e32b2efc622f9a3d9b25668221c88d850eb6))

* Update docs/src/tutorials/index.md

Co-authored-by: Tolga Dincer &lt;tolgadincer@gmail.com&gt; ([`204436a`](https://github.com/yambottle/element-deeplabcut/commit/204436a71362b6bb622bb4009121cfed32bcc3c3))

* Fetch from cbroz1:main ([`55422b3`](https://github.com/yambottle/element-deeplabcut/commit/55422b37d1e682404a6fabefa8bb110e9385badf))

* Add notebooks to docs; Add markdown linting ([`d306b34`](https://github.com/yambottle/element-deeplabcut/commit/d306b345b98c3382b63289b2ec01b6802ade8fd4))

* Merge pull request #64 from kabilar/main

Fix changelog for CICD ([`128f66d`](https://github.com/yambottle/element-deeplabcut/commit/128f66d180519852f4343d961c04e07a412a1af9))

* Fix changelog for CICD ([`dbd8c49`](https://github.com/yambottle/element-deeplabcut/commit/dbd8c49d6988545939c9c06f3d9ef116a606a3b8))

* Merge pull request #63 from kabilar/main

Update styling for docs launch ([`411225b`](https://github.com/yambottle/element-deeplabcut/commit/411225b6f3b57f3e6a7ae2a77554863775827342))

* Update changelog ([`a3a3a5f`](https://github.com/yambottle/element-deeplabcut/commit/a3a3a5f1be5dcec25e4bbbc0e98b740b0413ca40))

* Update social icon colors ([`bd52c5c`](https://github.com/yambottle/element-deeplabcut/commit/bd52c5ca0a2b211396c2a7269a40caaf6a021c71))

* Update format ([`9b77e82`](https://github.com/yambottle/element-deeplabcut/commit/9b77e8285c973d833fb23d0a5ded5ad57e93501e))

* Update logo in yaml ([`d57826e`](https://github.com/yambottle/element-deeplabcut/commit/d57826e543469ec76662a70a46026225081d6b90))

* Update logos ([`dd437cf`](https://github.com/yambottle/element-deeplabcut/commit/dd437cf6bb35e45a774aeba56bfd5f38541cacba))

* Add drawio version ([`c38f187`](https://github.com/yambottle/element-deeplabcut/commit/c38f187c06a0d2ed1925379a50b28dc20b713aaf))

* Update diagram ([`8e74276`](https://github.com/yambottle/element-deeplabcut/commit/8e74276bb2ce1bde9544838e6d9b2325c7b36e47))

* Update diagram ([`40d541c`](https://github.com/yambottle/element-deeplabcut/commit/40d541c1cd63ccbf88af76cd68cb31b904e87253))

* Update text format ([`b721de3`](https://github.com/yambottle/element-deeplabcut/commit/b721de3bb82233312399c4454885c8a8b31f710e))

* Update to transparent background ([`2b66228`](https://github.com/yambottle/element-deeplabcut/commit/2b662284c095f9ee0debdf5ca55b16bedbaed783))

* Add flowchart ([`0d5deae`](https://github.com/yambottle/element-deeplabcut/commit/0d5deae05a88abb28f30d159b6c7f58a6f3e3d01))

* Remove next/previous navigation from footer ([`29291f5`](https://github.com/yambottle/element-deeplabcut/commit/29291f54696980b84647e91d01581d44adf6b0a7))

* Remove google analytics feedback ([`6923912`](https://github.com/yambottle/element-deeplabcut/commit/692391205525a91a016bbd32aa02c508cba8bd6a))

* Merge pull request #62 from CBroz1/main

Fix typos ([`dbb2245`](https://github.com/yambottle/element-deeplabcut/commit/dbb224561dd2e068797f79b754c07f6a6ae33a69))

* Revise docstrings ([`eacf864`](https://github.com/yambottle/element-deeplabcut/commit/eacf864c2203d11b6f33a64407130693dc3f1fb9))

* Merge pull request #60 from sidhulyalkar/main

change nframes from smallint to int data type ([`e07dc77`](https://github.com/yambottle/element-deeplabcut/commit/e07dc77935f9345de6882cec12981d2d23c62a1d))

* change nframes from smallint to int data type ([`f54e054`](https://github.com/yambottle/element-deeplabcut/commit/f54e054014470add4b38db772e6daf76f192f3b8))

* Merge pull request #59 from JaerongA/docs

fix minor typos &amp; data types ([`6bb2861`](https://github.com/yambottle/element-deeplabcut/commit/6bb2861e368252409825de5ed5ff60c9dddcd2ff))

* fix typo &amp; data type in models.py ([`ccdf1ec`](https://github.com/yambottle/element-deeplabcut/commit/ccdf1ec0c9e0c0ff474dd1bf559ba357fbaa941e))

* fixed minor typos ([`04965e2`](https://github.com/yambottle/element-deeplabcut/commit/04965e2054e12d9ae554df52ec151f31fd4995cd))

* fix typos ([`d0a80ca`](https://github.com/yambottle/element-deeplabcut/commit/d0a80ca5f1155881c89e2eb575abb8d5da55ec24))

* Merge pull request #58 from CBroz1/main

Version as env variable ([`0db4ba8`](https://github.com/yambottle/element-deeplabcut/commit/0db4ba8e931e77f8c1df2cde38d49f046e3a362c))

* Render API in source order ([`17af889`](https://github.com/yambottle/element-deeplabcut/commit/17af88935df8a668104b3fc1602531162087765d))

* Fix URL ([`1f9c277`](https://github.com/yambottle/element-deeplabcut/commit/1f9c277126fc86e77ae6b842eb05e15761dd10a0))

* Fix typo ([`11c1a55`](https://github.com/yambottle/element-deeplabcut/commit/11c1a5594d04868171de690b12dc5b421cf870c8))

* Version as env variable ([`352c44f`](https://github.com/yambottle/element-deeplabcut/commit/352c44f98325cb79a249026d84310bff8417e7e2))

* Merge pull request #57 from CBroz1/main

Add 404, chatbot. Remove extra CICD items ([`11b627d`](https://github.com/yambottle/element-deeplabcut/commit/11b627de820125dc82ef0eaac67cecd48ea06bcf))

* Add 404, chatbot. Remove extra CICD items ([`87d541c`](https://github.com/yambottle/element-deeplabcut/commit/87d541c5cb4fc3602ae0b8f616fe2a1f0fb24834))

* Add missing changelog link ([`0dd064a`](https://github.com/yambottle/element-deeplabcut/commit/0dd064aa333cfc38d9da5e2fbe77f3b48a529c40))

* Merge branch &#39;main&#39; of https://github.com/datajoint/element-deeplabcut into docs-tutorial ([`4422725`](https://github.com/yambottle/element-deeplabcut/commit/4422725823f263d7c4acf06b8ce36942805bb260))

* Merge pull request #56 from CBroz1/docs

Add docs ([`99894bc`](https://github.com/yambottle/element-deeplabcut/commit/99894bc67e8ff4cf83596de88079b0734a0b0223))

* Element API docs -&gt; https urls ([`b7c5122`](https://github.com/yambottle/element-deeplabcut/commit/b7c5122a4616fc8a79477256bcc4eba5daddffbf))

* Fix links in concepts ([`157d545`](https://github.com/yambottle/element-deeplabcut/commit/157d545eb21b6d83b08656ac39daf30d706c6c77))

* Version bump ([`2d7c588`](https://github.com/yambottle/element-deeplabcut/commit/2d7c588eee1139538d11adac69c23d9f6a2a001a))
...
element_deeplabcut/model and train: Add attributes to docstrings ([`4394572`](https://github.com/yambottle/element-deeplabcut/commit/4394572fbc9cb4cc24403ba4cd8d8cfd441cc252))

* Apply suggestions from code review

Co-authored-by: Kabilar Gunalan &lt;kabilar@datajoint.com&gt; ([`5436db8`](https://github.com/yambottle/element-deeplabcut/commit/5436db878faf82a7d940c8217f0e3adfa502d584))

* Apply suggestions from code review

Co-authored-by: Kabilar Gunalan &lt;kabilar@datajoint.com&gt; ([`bc05121`](https://github.com/yambottle/element-deeplabcut/commit/bc05121bc9ffd0e42aab40777ab0965baaf51f70))

* Add full tutorial draft ([`d00a1f7`](https://github.com/yambottle/element-deeplabcut/commit/d00a1f7fe5acf4ccac61f622c32ad91f9b6dbb28))

* Remove Tutorials content, replace with ComingSoon ([`2397f4c`](https://github.com/yambottle/element-deeplabcut/commit/2397f4c2cee54b7fd7f1e1192d7d20682f286a67))

* Concepts.md: Move partnerships above architecture ([`395537e`](https://github.com/yambottle/element-deeplabcut/commit/395537eac06940d2a41495fd4fe03a8b162d2d85))

* Change title on index.md ([`fcc4c0c`](https://github.com/yambottle/element-deeplabcut/commit/fcc4c0c23e4d02181ff56c4a609fb320d1a3a9de))

* Add analytics key to docker compose ([`90682c1`](https://github.com/yambottle/element-deeplabcut/commit/90682c1b0acb478a6254d96494bc1ff7f11085c0))

* Apply suggestions from code review

Co-authored-by: Kabilar Gunalan &lt;kabilar@datajoint.com&gt; ([`285dfa1`](https://github.com/yambottle/element-deeplabcut/commit/285dfa1faa86e95cb6b6e851f86288a33cea7ad3))

* Add high level descriptions and DLC steps ([`064f721`](https://github.com/yambottle/element-deeplabcut/commit/064f7214ff494f2ae75223dad02c0fa0d3386f31))

* Merge branch &#39;docs2&#39; of https://github.com/CBroz1/element-deeplabcut ([`0a28279`](https://github.com/yambottle/element-deeplabcut/commit/0a282796f9ccfbdfa6fd35f56383e5202ca127b7))

* Citation to own page. Changelog to top level ([`31d834a`](https://github.com/yambottle/element-deeplabcut/commit/31d834a696ed6942d62c20a99f2828fe3b16fd50))

* Merge branch &#39;docs&#39; of https://github.com/CBroz1/element-deeplabcut into docs ([`939abe0`](https://github.com/yambottle/element-deeplabcut/commit/939abe013344201cb8ed62b57c47e5b359e6d18a))

* Update docs/src/tutorials.md

Co-authored-by: Kabilar Gunalan &lt;kabilar@datajoint.com&gt; ([`7b40fe0`](https://github.com/yambottle/element-deeplabcut/commit/7b40fe07959a7ebc7c1f19e37d82a45546a616a3))

* Apply suggestions from code review

Co-authored-by: Kabilar Gunalan &lt;kabilar@datajoint.com&gt; ([`f991cbe`](https://github.com/yambottle/element-deeplabcut/commit/f991cbea6d1debd0df2b9474d04dd89dd499ffd4))

* Apply suggestions from code review

Co-authored-by: Kabilar Gunalan &lt;kabilar@datajoint.com&gt; ([`b410b55`](https://github.com/yambottle/element-deeplabcut/commit/b410b554bf74305c9c8c2744731ba967b95d736f))

* Revert docker compose edits ([`8e36f5b`](https://github.com/yambottle/element-deeplabcut/commit/8e36f5bddb3c94348a64e6d124d3428ee86b6009))

* test with mkdocs instead of mike ([`eac8be4`](https://github.com/yambottle/element-deeplabcut/commit/eac8be426635828b0fd8b07512ee0bb31bc447ad))

* Add global safe config hack ([`14485be`](https://github.com/yambottle/element-deeplabcut/commit/14485be90e05006acce751ef3d24a81c9b401af7))

* Remove workflow-dispatch trigger from mkdocs-build workflow ([`dc90bd1`](https://github.com/yambottle/element-deeplabcut/commit/dc90bd1b56d4b9c8a1eae9f8219aa91801415aee))

* Remove tag check from mkdocs-build ([`4016d49`](https://github.com/yambottle/element-deeplabcut/commit/4016d49ab65a263c8c299f85dffbdd21f47ba9fe))

* Add staging CICD, Add element-generic mkdocs publish ([`bc3fbf0`](https://github.com/yambottle/element-deeplabcut/commit/bc3fbf06a4c4687d8d3ec0166099f70acc3e8d31))

* Mention DANDI upload ([`77a0629`](https://github.com/yambottle/element-deeplabcut/commit/77a06294395ee5f23c3c99a48726ded809f65ffc))

* Add codebook mention. Revise changelog symbolic link ([`6d9125d`](https://github.com/yambottle/element-deeplabcut/commit/6d9125d199d09730b019c12d4047c458312c5a75))

* Add codebook mention to tutorials#notebooks ([`7e0be4e`](https://github.com/yambottle/element-deeplabcut/commit/7e0be4e2764ca4a86a70e01319049d92455339e6))

* Home nav to docs/elements/ ([`0f6f550`](https://github.com/yambottle/element-deeplabcut/commit/0f6f5500c2b9b76fb71940eccfdbe08c2eaa08c0))

* Hard wrap; Concepts#data-export ([`ae75dae`](https://github.com/yambottle/element-deeplabcut/commit/ae75daea87607b5fa6dca27bd9ffe159b771532f))

* Apply suggestions from code review 3

Co-authored-by: Kabilar Gunalan &lt;kabilar@datajoint.com&gt; ([`7110b72`](https://github.com/yambottle/element-deeplabcut/commit/7110b723f1144daa21c9202f978c19f44e97b4fe))

* Apply suggestions from code review 2

Co-authored-by: Kabilar Gunalan &lt;kabilar@datajoint.com&gt; ([`9b4ce4d`](https://github.com/yambottle/element-deeplabcut/commit/9b4ce4d9f43c1e2f7891efaf9546f19f708ed66a))

* Apply suggestions from code review

Co-authored-by: Kabilar Gunalan &lt;kabilar@datajoint.com&gt; ([`276526b`](https://github.com/yambottle/element-deeplabcut/commit/276526b03f757742b94c75b8dd689996f8811423))

* Edits to make_pages to handle edge cases ([`c34289a`](https://github.com/yambottle/element-deeplabcut/commit/c34289a4ece95be61e4348db917d2a0892a2c883))

* Misc extra contributor notes ([`061f39f`](https://github.com/yambottle/element-deeplabcut/commit/061f39f0effa494de6f7cdbabd4f53ce5c9a1ee7))

* Revise doc structure ([`4fe5fc0`](https://github.com/yambottle/element-deeplabcut/commit/4fe5fc0f2ed63bb835843f92c77dfc484e27c66c))

* Docstrings -&gt; Google style; edit css style for blue main ([`afd4602`](https://github.com/yambottle/element-deeplabcut/commit/afd4602d42e1e07e32daab8cd3740d36e40d4c0f))

* Merge pull request #10 from guzman-raphael/docs

Include workflow API docs ([`6fff4ab`](https://github.com/yambottle/element-deeplabcut/commit/6fff4ab80c3f175daf6ad2bff88a24fdbba60a8b))

* Include workflow API if applicable. ([`6ca812a`](https://github.com/yambottle/element-deeplabcut/commit/6ca812a9aed85f68a3171ce8d0ddfd28eddf0d8c))

* Fix merge conflicts. ([`b511e8e`](https://github.com/yambottle/element-deeplabcut/commit/b511e8e4c7718b680a0fae251904b013fde0bf2e))

* Merge branch &#39;main&#39; of https://github.com/datajoint/element-deeplabcut into docs ([`116fd90`](https://github.com/yambottle/element-deeplabcut/commit/116fd90e1588bbeec78a08e822680ece6ea5abb6))

* WIP: update docs to include workflow API docs ([`dece185`](https://github.com/yambottle/element-deeplabcut/commit/dece1854c5fd572f5f4243d82ed704894d121a1e))

* Add docs ([`081d3f7`](https://github.com/yambottle/element-deeplabcut/commit/081d3f76bb83e797838f0b1ff623fd8e3213eb96))

* Merge pull request #54 from CBroz1/main

Prep for pypi publish ([`1fa6984`](https://github.com/yambottle/element-deeplabcut/commit/1fa69844c5b87e36d43939ba2e9bfbc1da5a7f5e))

* Prep for pypi publish ([`346e164`](https://github.com/yambottle/element-deeplabcut/commit/346e164295f8c2f765c7585ae8ad3e5d99d488a0))

* Merge pull request #46 from CBroz1/dev

Add NWB export function ([`d2e4286`](https://github.com/yambottle/element-deeplabcut/commit/d2e4286512df21b66b0c2b5c1e5fd2c82881d6a5))

* Update element_deeplabcut/export/nwb.py ([`b9580de`](https://github.com/yambottle/element-deeplabcut/commit/b9580de6a4418738a1c2b8b06f50302e7ece5a77))

* Update element_deeplabcut/export/nwb.py

Co-authored-by: Tolga Dincer &lt;tolgadincer@gmail.com&gt; ([`a8acb6b`](https://github.com/yambottle/element-deeplabcut/commit/a8acb6b6f16c37bf77e15c68d536324d5db5e862))

* Apply suggestion from code review

Co-authored-by: Dimitri Yatsenko &lt;dimitri@datajoint.com&gt; ([`e65f14f`](https://github.com/yambottle/element-deeplabcut/commit/e65f14ff125cbc2d7c14d4bec35e6414fe4a450d))

* Add logging via datajoint ([`5ff9624`](https://github.com/yambottle/element-deeplabcut/commit/5ff962419a60000bec1bd7cfb181ab9a51be0019))

* Remove unnecessary import ([`8057632`](https://github.com/yambottle/element-deeplabcut/commit/8057632fd00d9860fdd3b4d91cffa3554f396e0d))

* Merge branch &#39;main&#39; of https://github.com/datajoint/element-deeplabcut into dev ([`424becb`](https://github.com/yambottle/element-deeplabcut/commit/424becb2daad30975737ad6b7b3733fe73c59ce7))

* Refactor based on DLC2NWB#10 ([`6121e70`](https://github.com/yambottle/element-deeplabcut/commit/6121e707c103765b60f708d421c1610547e50203))

* WIP: add NWB export ([`efaf34a`](https://github.com/yambottle/element-deeplabcut/commit/efaf34a3868da243ab6fadc3c356a5aa381b119b))

* Merge pull request #52 from tdincer/main

add opencv-python-headless in requirements ([`2143d20`](https://github.com/yambottle/element-deeplabcut/commit/2143d203decbc8247ee9f164658d5e108b34c877))

* add opencv-python-headless in requirements ([`6624728`](https://github.com/yambottle/element-deeplabcut/commit/662472892a87e4cca1b7ee37331625cb995be97f))

* Merge pull request #51 from tdincer/main

bug fix: missing f for formatted string ([`cf08e3e`](https://github.com/yambottle/element-deeplabcut/commit/cf08e3e3159fc0be5212f1d2367851fa495e8f3d))

* add log ([`172a4e3`](https://github.com/yambottle/element-deeplabcut/commit/172a4e3c8594a03914cbdd31439bdd7b8a9fba45))

* Merge branch &#39;main&#39; of https://github.com/datajoint/element-deeplabcut ([`44ec30e`](https://github.com/yambottle/element-deeplabcut/commit/44ec30eebefcecd96bc445ec00169bc92a5a60f7))

* Merge pull request #50 from tdincer/main

relocate imports ([`2d96b92`](https://github.com/yambottle/element-deeplabcut/commit/2d96b926ecafe02947d3370d73dd6b139b602f3b))

* Update CHANGELOG.md

Co-authored-by: Chris Brozdowski &lt;CBrozdowski@yahoo.com&gt; ([`ddb32b1`](https://github.com/yambottle/element-deeplabcut/commit/ddb32b12286214cfb0bc55872c3df5e0a7ecaad5))

* Update element_deeplabcut/version.py

Co-authored-by: Chris Brozdowski &lt;CBrozdowski@yahoo.com&gt; ([`009fcc8`](https://github.com/yambottle/element-deeplabcut/commit/009fcc8bec086d241bd916f7f8ba92a4cbaf2fbd))

* bug fix: missing f for formatted string ([`68be599`](https://github.com/yambottle/element-deeplabcut/commit/68be599804436685ffb53592d4d60a784de10e98))

* relocate module imports to the top of the file ([`bfd8624`](https://github.com/yambottle/element-deeplabcut/commit/bfd8624f0de96158147926cfa7d18ecb038a6513))

* relocate imports ([`82a5a79`](https://github.com/yambottle/element-deeplabcut/commit/82a5a792882e592f40aac545e16cfc88e5570240))

* Merge pull request #49 from tdincer/main

Decrease model_description char length ([`96c2a9b`](https://github.com/yambottle/element-deeplabcut/commit/96c2a9b71898fefd0509b9a55951e94f0448fcd1))

* model_description size change ([`50438cb`](https://github.com/yambottle/element-deeplabcut/commit/50438cb2f942cee365555450a8deadca44d31abd))

* Merge branch &#39;main&#39; of https://github.com/datajoint/element-deeplabcut ([`d527fcb`](https://github.com/yambottle/element-deeplabcut/commit/d527fcb5a8c1f12ea343f2d3575fdd99009be0b6))

* Merge pull request #48 from tdincer/main

Increase model description attr&#39;s size ([`3acc964`](https://github.com/yambottle/element-deeplabcut/commit/3acc96495e9d8e7a8fbb534dc90f55bc41ee6ed1))

* adjust model_description char length ([`58af1ed`](https://github.com/yambottle/element-deeplabcut/commit/58af1ed15632e0c29531e8d9683a11ef1e261c2f))

* Merge branch &#39;main&#39; of https://github.com/datajoint/element-deeplabcut ([`a08bbac`](https://github.com/yambottle/element-deeplabcut/commit/a08bbacd93f0b71409f981cdf68167fb92ea2fc2))

* Merge pull request #47 from yambottle/main

fix(CICD): 🐛 CICD trigger fixed ([`02a57f8`](https://github.com/yambottle/element-deeplabcut/commit/02a57f8627d10b97ad4d577a7060dfa63b24339a))

* fix conflict ([`7219118`](https://github.com/yambottle/element-deeplabcut/commit/72191188e07cea6c1a6985b7bb9ea6af43139af1))

* Merge pull request #40 from CBroz1/main

Changes to parallel workflow integration tests ([`8a63b19`](https://github.com/yambottle/element-deeplabcut/commit/8a63b196869a194e1a27ee76e3d4dd6da5de87dd))

* Merge branch &#39;main&#39; of https://github.com/CBroz1/element-deeplabcut ([`1db662b`](https://github.com/yambottle/element-deeplabcut/commit/1db662bbf364a170ddaf42be1d58732f1efc68b8))

* Merge pull request #8 from yambottle/main

Include updated CICD ([`fabbb75`](https://github.com/yambottle/element-deeplabcut/commit/fabbb757e017e841bfd19460fac032aea20ee861))

* Fetch upstream ([`ddca6f6`](https://github.com/yambottle/element-deeplabcut/commit/ddca6f68376faee34d89b081300fc8702fb67d5e))

* Merge branch &#39;main&#39; of https://github.com/CBroz1/element-deeplabcut ([`980cdcb`](https://github.com/yambottle/element-deeplabcut/commit/980cdcb84c5568e6a35d50efa3e76c326a96471a))

* WIP: revise saved config to preserve original video_set ([`271b003`](https://github.com/yambottle/element-deeplabcut/commit/271b00355352ae296c91166743c8ba3337405666))

* fix conflict ([`443548f`](https://github.com/yambottle/element-deeplabcut/commit/443548f3959965bcee2f7e4c5e7c4bb0b425477d))

* Merge branch &#39;chris-main&#39; ([`6283959`](https://github.com/yambottle/element-deeplabcut/commit/628395919278412c14f73c4facf77d1f1dd97923))

* Apply suggestions from code review

Co-authored-by: Tolga Dincer &lt;tolgadincer@gmail.com&gt; ([`8e1f72c`](https://github.com/yambottle/element-deeplabcut/commit/8e1f72c2bc4da617270e7b4e4a7f711ecdce333f))

* Merge branch &#39;main&#39; into main ([`5a7a3e4`](https://github.com/yambottle/element-deeplabcut/commit/5a7a3e437b5ee6a8cfa624bef51a378ba4989039))

* Version bump ([`4bbb209`](https://github.com/yambottle/element-deeplabcut/commit/4bbb20986eab9d7d5a90102c0b1f4ea8a3eba893))

* WIP #36 ([`6f193c1`](https://github.com/yambottle/element-deeplabcut/commit/6f193c1e8e344ccbf7d6f8b779e4fae8de076c9d))

* WIP: pin DLC version, rename saved yaml ([`b4cfe57`](https://github.com/yambottle/element-deeplabcut/commit/b4cfe57829ac6c540e39d1418b10a1dcee3bcca4))

* Apply suggestions from code review

Co-authored-by: Dimitri Yatsenko &lt;dimitri@datajoint.com&gt; ([`bf62231`](https://github.com/yambottle/element-deeplabcut/commit/bf62231a036decc1457216d83355091dee0e7d90))

* WIP: minor fix for save_yaml, permit file ext ([`f1b9b2d`](https://github.com/yambottle/element-deeplabcut/commit/f1b9b2d66db3d04b270507097cc8e82b50a32a61))

* WIP: revert videotype, see DeepLabCut #1900 ([`1fe2fd6`](https://github.com/yambottle/element-deeplabcut/commit/1fe2fd6910277b21701f64ad9c59648846d6289f))

* WIP: error workaround for analyze_videos videotypes param ([`614f02b`](https://github.com/yambottle/element-deeplabcut/commit/614f02b0869141ee2331de426c68ba2950d7219f))

* WIP: change config pointers to our fully managed dict ([`425714d`](https://github.com/yambottle/element-deeplabcut/commit/425714dca54d5071afc297c284457e66c7d20fab))

* WIP: minor bugfixes to output_dir and trainingsetindex as int ([`e630454`](https://github.com/yambottle/element-deeplabcut/commit/e63045453b3a1d70bd647ddfbcb46b696c8aa54b))

* WIP: #24, #26, #27 ([`8e58549`](https://github.com/yambottle/element-deeplabcut/commit/8e58549d98b434c5dfbebc11fc4bb5eebb8bf16f))

## v0.1.1 (2022-07-18)

### Documentation

* docs: 🐛 changelog remove unreleased and &#39;v&#39; in the tag ([`e194858`](https://github.com/yambottle/element-deeplabcut/commit/e194858edc11f0914da972a6306f10dcea1ec0c5))

* docs(CICD): 🔖 ([`cc95c5b`](https://github.com/yambottle/element-deeplabcut/commit/cc95c5baaf05f5472d8f1f1ff4f2511f0e8a601a))

### Feature

* feat(CICD): ✨ use workflow_run ([`22d0959`](https://github.com/yambottle/element-deeplabcut/commit/22d0959ee39d0523b5d93b5d8201e60b4e618696))

* feat(CICD): 🔖 call reusable cicd with test release ([`32d01ca`](https://github.com/yambottle/element-deeplabcut/commit/32d01ca6a04cb0d160bb4bb323b45d2620e4c62c))

* feat(CICD): ✨ add pypi ([`db5fdd8`](https://github.com/yambottle/element-deeplabcut/commit/db5fdd85a286310058ca5c32484ba59ecd2c7e42))

* feat(CICD): 🔖 point to prod CI ([`d6b2aa3`](https://github.com/yambottle/element-deeplabcut/commit/d6b2aa3b42f2886cc52fc2bb0dc9d230027c62a2))

* feat(CICD): ✨ include debian image build ([`6ba5e73`](https://github.com/yambottle/element-deeplabcut/commit/6ba5e73f23e405c1eeb69a6747db475d17533866))

* feat(CICD): ✨ refer centralized Dockerfile and docker-compose-build.yaml ([`c685dc4`](https://github.com/yambottle/element-deeplabcut/commit/c685dc466bedd31b923ef6d18b84d1c1679a7988))

* feat(CICD): 🐛 add build docker-compose yaml ([`103252f`](https://github.com/yambottle/element-deeplabcut/commit/103252f32c7ad5f20163c4b05ddb1126049e903c))

* feat(CICD): ✨ calling reusable workflow ([`c7152b0`](https://github.com/yambottle/element-deeplabcut/commit/c7152b0775217eea7156253e254a0f03ec735fb4))

### Fix

* fix(CICD): 🐛 if syntax ([`a4568b6`](https://github.com/yambottle/element-deeplabcut/commit/a4568b6767585876e09058e71aed43f6def09f00))

* fix(CICD): 🐛 fix inputs ([`28a2203`](https://github.com/yambottle/element-deeplabcut/commit/28a2203679f35f826bbe6c7e7aac1e8f4f21dafb))

* fix(CICD): 🐛 update logic ([`70c2bab`](https://github.com/yambottle/element-deeplabcut/commit/70c2bab581520a232b79ca2e443e7bd2c53b1a22))

* fix(CICD): 🐛 update reference ([`9c4dcaf`](https://github.com/yambottle/element-deeplabcut/commit/9c4dcaf8b850ea6e5ced7d74f8960eb76151ff49))

* fix(CICD): 🐛 simplify logic ([`6b3d2e7`](https://github.com/yambottle/element-deeplabcut/commit/6b3d2e7c5e190a96ebb9929738b3a2300037e32c))

* fix(CICD): 🐛 trigger ([`629022a`](https://github.com/yambottle/element-deeplabcut/commit/629022aa2a153bb9ce0d6a0c44c68389b3762d0e))

* fix(CICD): 🐛 typo ([`e2cb051`](https://github.com/yambottle/element-deeplabcut/commit/e2cb051044d9e990c8c47ba1385dca05d1f52d1c))

* fix(CICD): 🐛 have to pass secrets in ([`7ac4d79`](https://github.com/yambottle/element-deeplabcut/commit/7ac4d79c106b08c8bdaabb69625f67a161d8928e))

* fix(CICD): 🐛 only one call is needed, otherwise conflict when create release ([`79223cd`](https://github.com/yambottle/element-deeplabcut/commit/79223cd68f4fd6ec876cb67b8fcceea1c71a6c52))

* fix(CICD): 🐛 fix typo ([`e7fde40`](https://github.com/yambottle/element-deeplabcut/commit/e7fde407bef0b3475e47bafa47a6d083c69c3fd2))

* fix(CICD): 🐛 fix typo ([`381f89f`](https://github.com/yambottle/element-deeplabcut/commit/381f89fff2f5e2ff5a79fbdc9959f083f267a6a8))

* fix(CICD): 🐛 fix typo ([`e0af5ca`](https://github.com/yambottle/element-deeplabcut/commit/e0af5caff326bd2062bea9cd6685f9acfc77fc25))

* fix(CICD): 🐛 update changelog to unrelease ([`80c2f59`](https://github.com/yambottle/element-deeplabcut/commit/80c2f590a06ba9ad9b7d373b2c223bc590d3cd6f))

* fix(CICD): 🐛 rollback changelog ([`ccde295`](https://github.com/yambottle/element-deeplabcut/commit/ccde2958133405ae8df8112f943445275fb10665))

* fix(CICD): 🐛 fix DISTRO to DIST ([`ef00305`](https://github.com/yambottle/element-deeplabcut/commit/ef00305950938481e1d9c07484936dbee76c50f5))

* fix(CICD): 🐛 add Dockerfile ([`02d3a95`](https://github.com/yambottle/element-deeplabcut/commit/02d3a953fcfe9938827546dd07a66972a735a518))

* fix(CICD): 🐛 add docker-compose-build.yaml ([`a77db0c`](https://github.com/yambottle/element-deeplabcut/commit/a77db0c988ca9c74b7f25ad7007d1f9e7355d75f))

* fix(CICD): 🐛 fix push trigger ([`9bd44fb`](https://github.com/yambottle/element-deeplabcut/commit/9bd44fb8b0b9f9b8968af4cc4281e4858e839dbd))

* fix(CICD): 🐛 refer dev fork CI ([`5610b32`](https://github.com/yambottle/element-deeplabcut/commit/5610b32c62c3ffcacaa5944c330962ad020425fe))

### Test

* test(CICD): 🔖 ([`1055555`](https://github.com/yambottle/element-deeplabcut/commit/1055555ab1739d2ede1464cad7a4a3d2462c35ff))

* test(CICD): 🐛 job name ([`70918a7`](https://github.com/yambottle/element-deeplabcut/commit/70918a7160e52c274cc17f755d3999c552d814e6))

### Unknown

* increase model_description char ([`2af9d74`](https://github.com/yambottle/element-deeplabcut/commit/2af9d74377dff0be9fc90c6692d8479e7df043b7))

* Merge pull request #43 from tdincer/main

fix videotype ([`631d7d5`](https://github.com/yambottle/element-deeplabcut/commit/631d7d5fc76cba438dba4853c4b631884fce2d64))

* Update requirements.txt

Co-authored-by: Chris Brozdowski &lt;CBrozdowski@yahoo.com&gt; ([`68134cf`](https://github.com/yambottle/element-deeplabcut/commit/68134cf447fd20a3a83f3feb19b7b84c1abce67a))

* videotype fix ([`d867b7d`](https://github.com/yambottle/element-deeplabcut/commit/d867b7df9f62ec27e00f22591b6f99871094cfdc))

* videotype fix ([`46adbb8`](https://github.com/yambottle/element-deeplabcut/commit/46adbb8b52d8bf39abfec8735e4c47c8701e8c05))

* freeze version ([`c1753c1`](https://github.com/yambottle/element-deeplabcut/commit/c1753c17d2f7b5e7d53256a59d82afbe79ec6cc8))

* revert ([`0d044e2`](https://github.com/yambottle/element-deeplabcut/commit/0d044e2925e3c2d991ebbec0969700be0e9c93e3))

* Merge pull request #35 from yambottle/main

changelog fix type | add test release cicd ([`66802d6`](https://github.com/yambottle/element-deeplabcut/commit/66802d675d5193596b434ca577b8f212b6c0dd9a))

* resolve conflict ([`31bfde5`](https://github.com/yambottle/element-deeplabcut/commit/31bfde545c8994e30456f1d0430bd83dea4598d1))

* Merge pull request #37 from kabilar/main

Remove direct dependency for PyPI release ([`6ee17ef`](https://github.com/yambottle/element-deeplabcut/commit/6ee17efd3a3140173648bd780f05d437a179bf81))

* Update changelog ([`0ded37e`](https://github.com/yambottle/element-deeplabcut/commit/0ded37eab4226fe9488b1c3ad7dc0a6cbcc2fe59))

* Remove dependency for PyPI release ([`6ced597`](https://github.com/yambottle/element-deeplabcut/commit/6ced59744a6dd4f4274dc78cb8e5f5973e86c413))

* Merge pull request #33 from yambottle/main

Enable reusable CICD ([`b5fc591`](https://github.com/yambottle/element-deeplabcut/commit/b5fc59190e4670b8381fc4c48a8ade2857c3d119))

* revert ([`a85e6ac`](https://github.com/yambottle/element-deeplabcut/commit/a85e6ac1c49bfcd4089960712a9d081e2ee5b82b))

* revert ([`fe34dcf`](https://github.com/yambottle/element-deeplabcut/commit/fe34dcfa36865ffde5e6e1c11ff84c0143e4bd69))

* revert videotype ([`21abbf5`](https://github.com/yambottle/element-deeplabcut/commit/21abbf529eb92686447afa14cdc7ea967827d16e))

* misc ([`69e58f4`](https://github.com/yambottle/element-deeplabcut/commit/69e58f43064499e591576a29b1c81078a4493719))

* freeze dlc version ([`dc81963`](https://github.com/yambottle/element-deeplabcut/commit/dc819634ec49b431a45deb88f630b258346123bf))

* Merge pull request #32 from tdincer/main

modify do_pose_estimation to write config.yaml in dlc_project_path ([`9bcb177`](https://github.com/yambottle/element-deeplabcut/commit/9bcb1779d3feb68b3170c9ad2fca86e4579834e2))

* modify do_pose_estimation to write config.yaml in dlc_project_path ([`9b5aeef`](https://github.com/yambottle/element-deeplabcut/commit/9b5aeef7c2990842c9fead86b9098956b382de43))

* Merge pull request #31 from tdincer/main

revert path find ([`7cc275a`](https://github.com/yambottle/element-deeplabcut/commit/7cc275ab29c1a750abe82120bb74a112e62a0828))

* add optional project name ([`682f67a`](https://github.com/yambottle/element-deeplabcut/commit/682f67aa74700af41284f6515f784a702a8ac644))

* Equipment -&gt; Device ([`664cec2`](https://github.com/yambottle/element-deeplabcut/commit/664cec233e1812ea24a5af593e979cd2d81d2446))

* revert path find ([`5a22175`](https://github.com/yambottle/element-deeplabcut/commit/5a221755f357771dba8b0f40e546cfef783b7fb4))

* Merge pull request #29 from tdincer/main

add yaml and cv2 imports ([`d5b1858`](https://github.com/yambottle/element-deeplabcut/commit/d5b185804c744272824d8e22c6d2a6fba8dace91))

* change changelog ([`9a97928`](https://github.com/yambottle/element-deeplabcut/commit/9a97928cf5e45f8ab609fbbaeba3d9a80bc8e075))

* fix project path ([`c816daf`](https://github.com/yambottle/element-deeplabcut/commit/c816daffc37c466c3ade4b7c50dc5d7c5d494585))

* revise model docstring ([`6fbc063`](https://github.com/yambottle/element-deeplabcut/commit/6fbc063fe3f1049f71a5243d8fcb9a186f5cc225))

* adopt function name to dlc version ([`db05b90`](https://github.com/yambottle/element-deeplabcut/commit/db05b90697d4b8c6cf787b6e18ed931e7d885c00))

* Merge branch &#39;main&#39; of https://github.com/tdincer/element-deeplabcut ([`3753ac0`](https://github.com/yambottle/element-deeplabcut/commit/3753ac0696bd596e08db19267869d2c52a3f8402))

* Merge branch &#39;datajoint:main&#39; into main ([`4f30c5d`](https://github.com/yambottle/element-deeplabcut/commit/4f30c5dd17ee5387c3e5ff8dcb802c2e3f21a846))

* Merge branch &#39;main&#39; of https://github.com/datajoint/element-deeplabcut ([`2ff1779`](https://github.com/yambottle/element-deeplabcut/commit/2ff1779db9ab50706e068723e6d8bd4605cf66a7))

* Merge pull request #28 from tdincer/main

move to &#39;Device&#39; upstream table. ([`8b4d910`](https://github.com/yambottle/element-deeplabcut/commit/8b4d910f3cfacb6a9ffdb10f88e1ec548c84ba5a))

* add changelog ([`1e4b489`](https://github.com/yambottle/element-deeplabcut/commit/1e4b4898d1620e36ce019ea10acc14fe1669ab41))

* add import yaml - forgotten from the last time ([`cced805`](https://github.com/yambottle/element-deeplabcut/commit/cced805e55ea367703fd9870b2ee480a6a19aedb))

* fix docstring of get_trajectory ([`7362d2c`](https://github.com/yambottle/element-deeplabcut/commit/7362d2c58897c5f025b6ae373e01c76213a825f1))

* add development.yaml ([`76ea933`](https://github.com/yambottle/element-deeplabcut/commit/76ea93367fbaef0399ff9c67e7151e5a0b0de26a))

* Merge branch &#39;main&#39; of https://github.com/tdincer/element-deeplabcut ([`60ef71f`](https://github.com/yambottle/element-deeplabcut/commit/60ef71ffd3e27af21c09ff85c92d0bf6c6442608))

* Update element_deeplabcut/model.py

Co-authored-by: Dimitri Yatsenko &lt;dimitri@datajoint.com&gt; ([`be07c8b`](https://github.com/yambottle/element-deeplabcut/commit/be07c8beedebb8d4a82e5229751bba2dfe697c2c))

* move imports back to the make functions ([`02a4f64`](https://github.com/yambottle/element-deeplabcut/commit/02a4f64dc6183eab44600ef36852720b52e37a19))

* Equipment -&gt; Device ([`bbf2dcc`](https://github.com/yambottle/element-deeplabcut/commit/bbf2dcca0a567c531c6dff59b82ecbe2cd633dff))

* remove version check from scorer_legacy ([`c3fe727`](https://github.com/yambottle/element-deeplabcut/commit/c3fe7270efa95b1c4de70011977bd29fede9cfff))

* put back the reference ([`1ed1043`](https://github.com/yambottle/element-deeplabcut/commit/1ed1043de125f89c13e97d0fa6b51376094071f3))

* bug fix ([`d2d7bd5`](https://github.com/yambottle/element-deeplabcut/commit/d2d7bd5e36f2fb9a251c0ea79fd24ba62b6d06fb))

* fix terminology ([`2040e37`](https://github.com/yambottle/element-deeplabcut/commit/2040e37e82a3c632383e37887318a3fc5211d982))

* improved training data handling ([`b7dc27b`](https://github.com/yambottle/element-deeplabcut/commit/b7dc27b81ad691f4dc1367c12e8f88d8e429fd16))

* Merge pull request #23 from CBroz1/dj

blackify ([`699a217`](https://github.com/yambottle/element-deeplabcut/commit/699a2178dcbc9a502ecfe2345e898db2594e25a5))

* Bump version in changelog ([`993377e`](https://github.com/yambottle/element-deeplabcut/commit/993377e8033cec09c3b8c0a511c0fb6c408107f1))

* Bump version in changelog ([`a4ccd34`](https://github.com/yambottle/element-deeplabcut/commit/a4ccd347159ce237172fae1c6ee1dd4582a66ea5))

* Bump version ([`ca2738f`](https://github.com/yambottle/element-deeplabcut/commit/ca2738f3a80213c8ef33b30aceae7f8b08df247f))

* blackify ([`8db4a54`](https://github.com/yambottle/element-deeplabcut/commit/8db4a541184379e11bc156f18fcc1b744f03cea4))

* Merge pull request #22 from CBroz1/main

Device -&gt; Equipment ([`b88c8dd`](https://github.com/yambottle/element-deeplabcut/commit/b88c8dd6051445928d5eb2916201b4b60ea33a0a))

* Device -&gt; Equipment ([`c6519c9`](https://github.com/yambottle/element-deeplabcut/commit/c6519c905d12f4c4805efb6fa400254306ad16c7))

* Merge pull request #19 from CBroz1/main

Update diagrams and YT link in README ([`5a9595d`](https://github.com/yambottle/element-deeplabcut/commit/5a9595d0c61916c50a797c0e08de5293744cab4e))

* add element_interface Issue #21 ([`7f2eddd`](https://github.com/yambottle/element-deeplabcut/commit/7f2eddde74c52613db855f7ce7a853267c2bd407))

* Diagrams: +subject. Link: YouTube thumbnail ([`f3bbd7f`](https://github.com/yambottle/element-deeplabcut/commit/f3bbd7ff3b050a24e338075923d6de772472181b))

* Update diagrams and YT link in README ([`141230d`](https://github.com/yambottle/element-deeplabcut/commit/141230dd6fcd1d135a98fdf7a248d29d59588437))

* Merge pull request #18 from ttngu207/main

minor update in `File`  table for consistency ([`0c71ecb`](https://github.com/yambottle/element-deeplabcut/commit/0c71ecbd60730a322b6631de1667155fde1f3bbe))

* Update element_deeplabcut/model.py

Co-authored-by: Chris Brozdowski &lt;CBrozdowski@yahoo.com&gt; ([`55e3040`](https://github.com/yambottle/element-deeplabcut/commit/55e30405ddf59efbb9ae69439363989234e54f20))

* non-nullable recording duration ([`4eb8a26`](https://github.com/yambottle/element-deeplabcut/commit/4eb8a260974603e10d0f62ffc6c9dbb99e7a7a17))

* minor update in `File`  table for consistency ([`1e6a8f0`](https://github.com/yambottle/element-deeplabcut/commit/1e6a8f0949854c3ebae53be6d17ff5db6d33ae11))

* Merge pull request #16 from kabilar/main

Update README ([`1062b4b`](https://github.com/yambottle/element-deeplabcut/commit/1062b4b26f75c310cb574cd5f13550ae11572b6a))

* Update README.md

Co-authored-by: Chris Brozdowski &lt;CBrozdowski@yahoo.com&gt; ([`e5dde7a`](https://github.com/yambottle/element-deeplabcut/commit/e5dde7a1416c817535279b3bd1b41d7f7f6bec4c))

* Update README.md

Co-authored-by: Chris Brozdowski &lt;CBrozdowski@yahoo.com&gt; ([`1f53b68`](https://github.com/yambottle/element-deeplabcut/commit/1f53b68fc637e8e11b559abe5d9766050bd01465))

* Update format ([`f631195`](https://github.com/yambottle/element-deeplabcut/commit/f6311955d6b38b93f701c014ab01193670c5e60e))

* Fix format ([`9f39af4`](https://github.com/yambottle/element-deeplabcut/commit/9f39af4d5e1aefbf04dfa537755d9a38748799a2))

* Fix typo ([`c7300eb`](https://github.com/yambottle/element-deeplabcut/commit/c7300eb009a7a802edab7c7032e02b1cea18c45b))

* Add links to elements.datajoint.org ([`e46c666`](https://github.com/yambottle/element-deeplabcut/commit/e46c6668b1f8d0b3591f94be3736846532c38b24))

* Add citation section ([`edf2aef`](https://github.com/yambottle/element-deeplabcut/commit/edf2aefcfeea47062eff8bb6033dd3fe893e0bc5))

* Merge pull request #15 from ttngu207/main

add RecordingInfo ([`705f154`](https://github.com/yambottle/element-deeplabcut/commit/705f1548b9dd0a03d1e3ff2eaa77b6c6c4d8368d))

* Update element_deeplabcut/model.py

Co-authored-by: Chris Brozdowski &lt;CBrozdowski@yahoo.com&gt; ([`c4ee40a`](https://github.com/yambottle/element-deeplabcut/commit/c4ee40ab38459c8a847b18c6dd30bb89e0c66863))

* add RecordingInfo ([`537c2ce`](https://github.com/yambottle/element-deeplabcut/commit/537c2cecc951ac6bfab5d1282be8a507dedbf806))

* Merge pull request #8 from CBroz1/main

`model.Model.BodyPart` insertion fix; README updates ([`6086009`](https://github.com/yambottle/element-deeplabcut/commit/6086009d157862e28214c6dacf3f3e85f35ac677))

* Apply suggestion from code review

Co-authored-by: Thinh Nguyen &lt;thinh@vathes.com&gt; ([`9f67d08`](https://github.com/yambottle/element-deeplabcut/commit/9f67d087f8c04406de88a1eae3ea71bed4ae00a1))

* fix model.Model.BodyPart table insertion; remove numpy require ([`2879ae1`](https://github.com/yambottle/element-deeplabcut/commit/2879ae1b946f4c24166a0a418a8cb4aab5fccebe))

* Merge branch &#39;main&#39; of https://github.com/datajoint/element-deeplabcut ([`65a4e60`](https://github.com/yambottle/element-deeplabcut/commit/65a4e60e33d72d44444b041ce8f9d91007bf53aa))

* Merge pull request #13 from datajoint/requirement-patch

Missing 0 on numpy requirement ([`e8961ff`](https://github.com/yambottle/element-deeplabcut/commit/e8961fffe0457ef43c93f5fb2735e1416bb05de4))

* Missing 0 on numpy requirement ([`df3c337`](https://github.com/yambottle/element-deeplabcut/commit/df3c33735b0af6ba593dbc2d8c96f6e3959f9295))

* Merge pull request #12 from kabilar/main

Minor text fix ([`9199a80`](https://github.com/yambottle/element-deeplabcut/commit/9199a8058865d8c6e1e1e6fd33f7230205add871))

* Minor text fix ([`a2bd409`](https://github.com/yambottle/element-deeplabcut/commit/a2bd4093ca29678d99157259cc08ff35f2d7f5d3))

* Merge pull request #5 from CBroz1/main

Pushing from `cbroz1:dev` discussion to `datajoint:main` ([`b8b5137`](https://github.com/yambottle/element-deeplabcut/commit/b8b5137673a6cd92794a0080098819c28f6efa1a))

* minor README updates ([`32524e2`](https://github.com/yambottle/element-deeplabcut/commit/32524e2bf9085bfdaf101f8039d0cb2a10e8191c))

* Merge pull request #5 from CBroz1/dev

Update schema split: `train`, `model` ([`b067e9f`](https://github.com/yambottle/element-deeplabcut/commit/b067e9fd5213139859e4781f54f8d80581cd731f))

* remove version info from __init__.py ([`9104105`](https://github.com/yambottle/element-deeplabcut/commit/910410511b22161683f38d50f537b8eac8068aa8))

* Apply suggestions from code review

Co-authored-by: Thinh Nguyen &lt;thinh@vathes.com&gt; ([`db6ecfb`](https://github.com/yambottle/element-deeplabcut/commit/db6ecfbbf329fd070ae40816927d03955d6a089d))
...
insert_new_params: Enforce int type on paramset_idx input. Previously failed to return
                   when attempting to insert a duplicate bc str(x)!=int(x) ([`26e6b44`](https://github.com/yambottle/element-deeplabcut/commit/26e6b4421247d506937f257dd8aba29684148cc8))

* update diagrams ([`6d74ab7`](https://github.com/yambottle/element-deeplabcut/commit/6d74ab7b918bbb00e975d758163d4f6beab8761f))

* VideoRecording to model schema ([`b842547`](https://github.com/yambottle/element-deeplabcut/commit/b84254785e42d2ae07e344bbf11bb84e2979ee51))

* typo fix ([`3371785`](https://github.com/yambottle/element-deeplabcut/commit/337178565023b81c533756417c93f8c4dc8308a8))

* update documentation ([`c7a3b03`](https://github.com/yambottle/element-deeplabcut/commit/c7a3b03297c977e1a0cafd3d93173314ba51f7fb))

* 3 -&gt; 2 schema ([`989b272`](https://github.com/yambottle/element-deeplabcut/commit/989b272c8fb1a39155eec6334cf5313318e610a0))

* Split dlc schema ([`09b4c7d`](https://github.com/yambottle/element-deeplabcut/commit/09b4c7d11c0091ec6c4dbbe0cdc2adb120b3510a))

* minor readme edit ([`bc054fb`](https://github.com/yambottle/element-deeplabcut/commit/bc054fb4336f1b165d77018119fc7a9d979f6bd3))

* Merge pull request #2 from CBroz1/dev

MVP here we come ([`015843a`](https://github.com/yambottle/element-deeplabcut/commit/015843a86af5aa17a7253e875bdfb23b5dfcfb02))

* Merge branch &#39;main&#39; into dev ([`b9fd1c9`](https://github.com/yambottle/element-deeplabcut/commit/b9fd1c9ac9c9404196a53f371d49f6ed5583c1da))

* rename `LabeledFrame` -&gt; `File` - to be more genelizable ([`8e4d7ce`](https://github.com/yambottle/element-deeplabcut/commit/8e4d7cedd58110cd5477c3b98267bffcbd8131ae))

* draft - using `TrainingVideo` table for training instead of `VideoRecording` ([`0e8cb2a`](https://github.com/yambottle/element-deeplabcut/commit/0e8cb2a10c9224d0c514f853bb14d5ba7ab109fe))

* edit README ([`2585ef3`](https://github.com/yambottle/element-deeplabcut/commit/2585ef3528fa7f2a03af42e850fd3c6053b2fbaa))
...
Apply suggestions from code review ([`3c8ff44`](https://github.com/yambottle/element-deeplabcut/commit/3c8ff44ce1ac6912000b6a08b3eee8fff59b9ba3))

* separate BodyPart functions - return list then insert ([`fb72d8c`](https://github.com/yambottle/element-deeplabcut/commit/fb72d8c2fdc5d66d48519712d22530c0d9e30ec1))

* null analyze_video_param handling ([`fbf3b7e`](https://github.com/yambottle/element-deeplabcut/commit/fbf3b7ec2e38eed9813d4ba30005ef39ac7236c2))

* additional code review suggestions ([`84f0d84`](https://github.com/yambottle/element-deeplabcut/commit/84f0d8485905a0cdd3cf35b8a7e9b6416026f7b9))

* Apply suggestion from code review

Co-authored-by: Thinh Nguyen &lt;thinh@vathes.com&gt; ([`540ba06`](https://github.com/yambottle/element-deeplabcut/commit/540ba06ae6fcdd7111c9db04ad394a9fe7327b1b))

* update diagram ([`88eb82f`](https://github.com/yambottle/element-deeplabcut/commit/88eb82f5272d9440e9e8503de6d2159158f5870f))
...
- do_pose_estimation - permit args passed from PoseEstimationTask.params ([`cef65ed`](https://github.com/yambottle/element-deeplabcut/commit/cef65ed8d4dc27ee672f887baa704c49cb5e048f))

* PEP8 ([`aa4961e`](https://github.com/yambottle/element-deeplabcut/commit/aa4961ea2a7fcc6a375edddaee22562f981a8fef))

* Merge pull request #4 from ttngu207/main

prototype revision no 2 ([`1d990db`](https://github.com/yambottle/element-deeplabcut/commit/1d990db72fcbfa8fd66a108b9c65539d6d036fd0))

* bugfix import errors ([`bdf7fb1`](https://github.com/yambottle/element-deeplabcut/commit/bdf7fb128070d65b445f00bb5695c6b1a58481e3))

* bugfix ([`23ff3d9`](https://github.com/yambottle/element-deeplabcut/commit/23ff3d97ba83eedb050d338f33ca618ba5090011))

* bugfix ([`7cd8f25`](https://github.com/yambottle/element-deeplabcut/commit/7cd8f251f27153ebe3ae50ce0c658cb8a7ebff9e))

* bugfix ([`18b3177`](https://github.com/yambottle/element-deeplabcut/commit/18b31772fc90feecb7b0ab3a32958bc8f6239b05))

* address review comment ([`b8df6d7`](https://github.com/yambottle/element-deeplabcut/commit/b8df6d7a676702d26f8110682b8813e915bef118))

* remove the need for `get_session_directory` - add helper method to infer output dir ([`06daffc`](https://github.com/yambottle/element-deeplabcut/commit/06daffc7a96072e5f426120ff40536f9e1212901))

* video_paths for model training ([`ed63cc4`](https://github.com/yambottle/element-deeplabcut/commit/ed63cc458e20fa37fae1e2574229b996bbca538f))

* accounts for `model_prefix` ([`3ad6838`](https://github.com/yambottle/element-deeplabcut/commit/3ad6838455f41fe669a0cbfda93b25385babd97a))

* update `ModelTraining` &#39;s `make()` - code cleanup ([`833bb7e`](https://github.com/yambottle/element-deeplabcut/commit/833bb7ecbb5ac7c37b4f0af0e6be7c25bca969fe))

* Merge branch &#39;dev&#39; of https://github.com/CBroz1/element-deeplabcut ([`62e2407`](https://github.com/yambottle/element-deeplabcut/commit/62e2407b30b9a36edf35b2fc333a58341e2166e8))

* Update dlc_draft.py ([`d4acd5f`](https://github.com/yambottle/element-deeplabcut/commit/d4acd5f6fa1d81e4686007656a7e1a157dcdb336))

* rename, restructure ([`511980e`](https://github.com/yambottle/element-deeplabcut/commit/511980e31e9c39c4535b53c3d2b8048090aa7283))

* add make for pose estimation ([`3140065`](https://github.com/yambottle/element-deeplabcut/commit/3140065cad69ca18524e57e9461a5212f7cdbf86))

* add dlc loader ([`a9a2e38`](https://github.com/yambottle/element-deeplabcut/commit/a9a2e3883c32cdfc1787ab8b41811fd88969ed3b))

* revised draft dlc ([`8ee7888`](https://github.com/yambottle/element-deeplabcut/commit/8ee788899772dcc0a4d52f79cdf0dd683add41c8))

* Merge pull request #3 from CBroz1/dev

Add functions to link tables ([`b498a02`](https://github.com/yambottle/element-deeplabcut/commit/b498a0295a4c9eb39d8c009f32a44dd8a11ebcc4))

* Update element_deeplabcut/dlc.py

Co-authored-by: Thinh Nguyen &lt;thinh@vathes.com&gt; ([`046064d`](https://github.com/yambottle/element-deeplabcut/commit/046064d1dbe7942e91f910ec993c6b106dbac31b))

* update diagram, readme ([`f264c6d`](https://github.com/yambottle/element-deeplabcut/commit/f264c6d60752f6061a9ddffa8eda6eda9a072c87))

* debug trajectory func ([`aa22fe6`](https://github.com/yambottle/element-deeplabcut/commit/aa22fe639503efddf6ed427cad66e846927d6fda))

* Rebase. See Details

rename, restructure
Update dlc_draft.py
Ingest function drafts ([`adf3e3f`](https://github.com/yambottle/element-deeplabcut/commit/adf3e3f9aec0b1d1346d350a6971cd717b3a629a))

* add make for pose estimation ([`294a3e8`](https://github.com/yambottle/element-deeplabcut/commit/294a3e8bd07b6f3de4482b8af4e4ca6d421e24b1))

* add dlc loader ([`3c8ace2`](https://github.com/yambottle/element-deeplabcut/commit/3c8ace2ff7bdb38d6401a0e1c7e55e3c4e77e24e))

* revised draft dlc ([`340bdee`](https://github.com/yambottle/element-deeplabcut/commit/340bdeee2b47b3e804f014703c2cca91aae097f0))

* Merge pull request #2 from ttngu207/main

Proposed schema design ([`1dd0f1e`](https://github.com/yambottle/element-deeplabcut/commit/1dd0f1ef2fca909b68c6b18a7cfb6e5bd88a6911))

* dlc_draft ([`f44efef`](https://github.com/yambottle/element-deeplabcut/commit/f44efef7e18b24e0901278282dc675492442302e))

* Merge pull request #1 from CBroz1/dev

Dev ([`6f2b9e0`](https://github.com/yambottle/element-deeplabcut/commit/6f2b9e0f1e916a802b3cf1da680c8289a95e0bdc))

* minor table structure edits with Thinh ([`6029422`](https://github.com/yambottle/element-deeplabcut/commit/6029422ab948fd80b4517101b08cc1e148a81f17))

* Merge from CBroz1/dev

Recent work ([`738999d`](https://github.com/yambottle/element-deeplabcut/commit/738999d482e205c1fd3a58c5c610a1769fadef6e))

* add diagram, README+CHANGELOG clarity ([`7ebdfc3`](https://github.com/yambottle/element-deeplabcut/commit/7ebdfc372ed97b144aad1935a8c98701b845a03d))

* NotImplementedError for multi-animal ([`1668f8f`](https://github.com/yambottle/element-deeplabcut/commit/1668f8fb630f35d61a7a31140a1e7488cd5d57c3))

* Cleanup: rm README notes and incomplete files ([`07977ab`](https://github.com/yambottle/element-deeplabcut/commit/07977abf8b9b0c682ad597c0577fb2769593f84d))
...
changelog/version.py: revise version number
.github/ISSUES: add bug_report and feature request ([`44dbe9c`](https://github.com/yambottle/element-deeplabcut/commit/44dbe9c1accd5e4e1fae6e751cd23ecc9cae5194))

* Functional 2D single-animal ingestion ([`873414f`](https://github.com/yambottle/element-deeplabcut/commit/873414f852fedb0eeb0879cedd217fb382db2a62))

* Load standard model. Recording-&gt;Model-&gt;Estimates ([`c516ea0`](https://github.com/yambottle/element-deeplabcut/commit/c516ea0aded44531a2721178415d1628b76d9834))

* README updates; tables WIP ([`f9f9b9a`](https://github.com/yambottle/element-deeplabcut/commit/f9f9b9a3502fcc01763c985e21bf8798c7b8fc37))

* revert ([`9b0af64`](https://github.com/yambottle/element-deeplabcut/commit/9b0af64453b5f2c2cb1a948d76e30cd47ec5626a))

* minor readme update ([`3165a6f`](https://github.com/yambottle/element-deeplabcut/commit/3165a6f0ab03f69f9d0dfb5f71046a082561e985))

* minor syntax fixes ([`626fa2d`](https://github.com/yambottle/element-deeplabcut/commit/626fa2da8549d3769cf9296b39a3071a3aebf72b))

* add .DS_Store ([`2f91758`](https://github.com/yambottle/element-deeplabcut/commit/2f91758469e16f798d8290749fea585d683951d4))

* major file structure, drafting ([`c43171a`](https://github.com/yambottle/element-deeplabcut/commit/c43171a688aa0f811a6f727d2b8b28b8b7d77687))

* Add files via upload ([`5d4e70d`](https://github.com/yambottle/element-deeplabcut/commit/5d4e70d4a9e49ea3ee32cf94d5dcf7359b2330b3))

* Initial commit rebased ([`31e4581`](https://github.com/yambottle/element-deeplabcut/commit/31e458180bc5205644f6e8c26c13ca93ae516dff))

* Initial commit ([`d8ffc2a`](https://github.com/yambottle/element-deeplabcut/commit/d8ffc2aa16858f7666f887910764890e02312914))
